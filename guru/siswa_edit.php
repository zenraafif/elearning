        ...
        <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
            <div class="white-box">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nama_user" class="form-control" value="<?= $siswa["nama_user"]?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="password" class="form-control" value="" placeholder="isi untuk mengganti password">
                </div>
                <!-- <div class="form-group">
                    <label>Role</label>
